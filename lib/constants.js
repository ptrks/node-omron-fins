...
// Name : [Read in Double Bytes, Read in Bit]
    'D' : [0x82, 0x02],//Data Memories
    'T' : [0x89, 0x09],//TIM
    'E' : [0xA0, 0x20],//Extended Memories, not supported by all PLC 
    'C' : [0xB0, 0x30],//CIO
    'W' : [0xB1, 0x31],//Work Area
    'H' : [0xB2, 0x32],//Holding Bit
    'A' : [0xB3, 0x33],//Auxiliary Bit
};
